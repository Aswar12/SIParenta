                ...
                <div class="md:mt-12 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-12 px-1  md:px-2 text-center md:text-left">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="#" class="block py-1 md:py-3 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-gray-500">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="#" class="block py-1 md:py-3 align-middle text-white no-underline hover:text-white border-b-2 border-gray-600">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="#" class="block py-1 md:py-3 pl-0  align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-gray-500">
