<nav aria-label="menu nav" class="bg-gray-800 pt-2 px-1 mt-0 h-auto  fixed md:absolute md:left-0 w-screen z-20 top-0">

    <div class="px-3 pt-2 md:pt-0 flex flex-inline justify-items-center justify-between">
        ...
        <div class="flex flex-1 justify-end text-white my-2 px-1">
            <div class="relative w-auto h-3  ">
                <button onclick="toggleDD('myDropdown')"
                    class="hover:bg-gray-500 rounded drop-button transition-transform text-white px-2">Hi,
                    {{
