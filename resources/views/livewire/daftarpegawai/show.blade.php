    ...
    <div id="main"
        ...
        <div class="bg-gray-800 md:pt-14 pt-6">
            <div class="rounded-tl-2xl bg-gradient-to-r from-blue-800 to-gray-900   px-4 shadow text-xl text-white">
                <h1 class="font-bold   pl-2">Daftar Pegawai</h1>
            </div>
        </div>
        @if($isOpen)
        @include('livewire.daftarpegawai.add')
        @endif
        <div
                ...
                <div class="pl-0 max-h-10 overflow-hidden w-96 mb-2">
                    <div class="w-96 inline-flex">
                        <div class="flex border-2 rounded mb-2">
                            <input id="satuan_kegiatan" wire:model="cari_pegawai" name="search_kegiatan" type="text"
                            ...
                            <table class="table-auto w-full flex-col overflow-x-auto overflow-y-auto max-h-4xl  ">
                                <thead
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <th class="p-2  whitespace-nowrap w-14">
                                ...
                                <tbody class="text-sm divide-y divide-gray-100 ">
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-00 py-2 ">
                                        ...
                                        <td class="p-2 whitespace-nowrap">
                                            <div class="text-center">{{ $pegawai->transaksi->count('transaksi') }}</div>
                                        </td>
                                        <td class="p-2 whitespace-nowrap">
                                            <?php
                                                $ak = 0;
                                            ?>
                                            @foreach($pegawai->transaksi as $transaksi)
                                            <?php
                                                $ak += $transaksi->vol_transaksi * $transaksi->kegiatan->butir->angka_kredit;
                                            ?>
                                            @endforeach
                                        ...
                                        <td class="justify-items-center whitespace-nowrap  pt-2 my-2  ">
                                            <button wire:click="edit({{ $pegawai->id }})"
                                                ...
                                                <span
                                                    ...
                                                    <i
                                                        class="fa-solid fa-pen-to-square mr-1 text-gray-600 hover:text-white"></i>Beri
                                                    Kegiatan
                                                </span>
                                            </button>
                                        </td>
