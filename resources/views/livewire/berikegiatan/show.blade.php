<div>
    <div id="main"
        ...
        <div
            ...
            <div class="w-full py-2 left-0 overflow-hidden mr-2">
                <!--Metric Card-->
                            ...
                            <table class="table-auto w-full flex-col overflow-x-auto overflow-y-auto max-h-4xl  ">
                                ...
                                <tbody class="text-sm divide-y divide-gray-100 ">
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-00 py-2 ">
                                        ...
                                        <td class="p-2 whitespace-nowrap">
                                            <div class="text-center  ">{{ $pegawai->fungsional->nama_fungsional }}</div>
                                        </td>
                                        <td class="p-2 whitespace-nowrap">
                                            <div class="text-sm text-center">{{ $pegawai->nip }}
                                            </div>
                                        </td>
            ...
            <div class="w-full py-2 left-0 overflow-hidden ml-2">
                ...
                <div class="pl-0 max-h-10 overflow-hidden w-96 mb-2">
                    <div class="w-96 inline-flex">
                        <button wire:click.prevent="$set('isOpen', true)"
                            class=" inline-flex justify-between justify-items-center  p-0.5 mb-2 mr-2  overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-indigo-600 to-blue-700 group-hover:from-indigo-600 group-hover:to-blue-700 hover:text-white">
                            <span
                                class="flex font-semibold place-items-center  px-2 text-gray-700 py-2 transition-all ease-in duration-75 bg-white rounded-md group-hover:bg-opacity-0 hover:text-white">
                                <i class="fa-solid fa-circle-plus text-gray-600 pr-0.5"></i> Tambah
                            </span>
                        </button>
                        <div class="flex border-2 rounded mb-2">
